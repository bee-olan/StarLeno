...
class GlavMenu
{
    ...
    public function build(): ItemInterface
    {
        ...
        $menu
            ->addChild('Инфа: Елит-М', ['route' => 'app.proekts.page_glavas.elitmatka'])
            ->setExtra('routes', [
...
//                ['route' => 'app.proekts.pasekas.elitmatkas.redaktors'],
        ...
        $menu
            ->addChild('Список', ['route' => 'app.proekts.page_glavas.elitmatka'])
...
//                ['pattern' => '/^app.proekts.page_glavas.elitmatka\..+/']
        ...
        $menu
            ->addChild('Родословная', ['route' => 'app.proekts.page_glavas.elitmatka'])
        //        $menu
...
//            ])
        ...
        $menu
            ->addChild('Регистрация', ['route' => 'app.proekts.page_glavas.elitmatka'])
//        $menu
...
//            ])
         ...
         $menu
             ->addChild('Сезоны', ['route' => 'app.proekts.page_glavas.elitmatka'])
//        $menu
