...
class PcheloMatka
{
    ...
    /**
     * @var Ras
     * @ORM\ManyToOne(targetEntity="App\Model\Drevos\Entity\Rass\Ras")
...
//
//        return $this->korotkoName = $korotkoNames[0]." : ".$this->title;
//    }
}
