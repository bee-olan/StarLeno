...
/**
 * @Route("app/proekts/page_glavas/brendmatka", name="app.proekts.page_glavas.brendmatka")
 */
...
//        dd($mestoNomer);
        ...
        return $this->render('/app/proekts/page_glavas/brendmatka/index.html.twig',
    ...
    {
        return $this->render('app/proekts/page_glavas/brendmatka/show.html.twig');
    }
}