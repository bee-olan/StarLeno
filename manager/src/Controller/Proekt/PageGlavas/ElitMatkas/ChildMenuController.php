...
namespace App\Controller\Proekt\PageGlavas\ElitMatkas;
...
/**
 * @Route("app/proekts/page_glavas/elitmatka/childs", name="app.proekts.page_glavas.elitmatka.childs")
 */
...
//        dd($mestoNomer);
        ...
        return $this->render('/app/proekts/page_glavas/elitmatka/childs/index.html.twig',
    ...
    {
        return $this->render('app/proekts/page_glavas/elitmatka/childs/show.html.twig');
    }
}